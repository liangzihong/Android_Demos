...
//                )));
        ...
        //设置recyclerview的adapter和拉到最底的事件
    ...
    /**
     * 如果刷新，就  fetch Forward（）和  MobclickAgent
     * fetchForward（）估计是调取网络操作，重新加载图片
     * MobclickAgent估计是类似 消息处理接口之类的吧
     */
    @Override
    ...
    /**
     * 设置如果按了菜单的关于，就跳转  activity的about_activity
     * @param item
     * @return
     */
    @Override
